...
func TestSolutionPart2_1(t *testing.T) {
	program := []int{3, 26, 1001, 26, -4, 26, 3, 27, 1002, 27, 2, 27, 1, 27, 26, 27, 4, 27, 1001, 28, -1, 28, 1005, 28, 6, 99, 0, 0, 5}
	expectedMaxValue := 139629729
	expectedMaxSettings := []int{9, 8, 7, 6, 5}

	maxValue, maxSettings := MaxValuePart2(program)
...
func TestSolutionPart2_2(t *testing.T) {
	...
	expectedMaxValue := 18216
	expectedMaxSettings := []int{9, 7, 8, 5, 6}
